...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-6 col-md-4 d-flex justify-content-center">
            <div class="bgBlue text-center w-75 p-2 rounded m-2 adminOption">
                <a href="addCustomer.php" class="btn"><i class="fas fa-user-plus fa-5x text-white"></i></a>
                <h3 class="text-white">Ajouter client</h3>
            </div>
        </div>
        <div class="col-6 col-md-4 d-flex justify-content-center">
