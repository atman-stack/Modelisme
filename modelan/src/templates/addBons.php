...
<div class="container-fluid container-lg">
    ...
    <form id="formBons" name="formBons" onsubmit="return false" >
        ...
        <div class="text-center">
            <button type="button" class="btn btn-primary mb-5" onclick="ajouterProduitLigne()"><i class="fas fa-plus text-white"></i> Ajouter produit</button>
            <button type="button" class="btn btn-primary mb-5" onclick="supprimerProduitLigne()"><i class="fas fa-minus text-white"></i> Supprimer produit</button>
        </div>
        ...
        <div class="text-center">
            <button type="submit" id="saveOrder" class="btn btn-primary mb-5" onclick="commande()"><i class="far fa-save text-white"></i> Sauvegarder</button>
            <button type="reset" class="btn btn-primary mb-5"><i class="fas fa-undo text-white"></i> Reinitializer</button>
        </div>
    </form>
